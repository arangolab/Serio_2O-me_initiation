...
## Table Processing
The following code collects the sequence files for Nm sites and processes them into an excel table.
```
python collectAllPositions.py -i "$SEQ_BEDS" -o "OUTPUT_EXCEL"
```
