...
# Load gene list
with open("/projects/b1042/Arangolab/2ometh/5utrSequence/nmPositionsGenome/nearCognateNmBoxplot/pos1Nmgenes.txt") as f:
...
for record in SeqIO.parse("results5UTR.fasta", "fasta"):
    ...
    if gene_name in target_genes:
        ...
        if not existing_record or cdna_length > int(existing_record.description.split("|")[-2]):
