# Nm Site Sequence Extraction Pipeline
...
Table S5 (excel file) contains a list of Nm sites detected in HEK293T, HeLa, and HepG2 cell lines. Each sheet contains the results for each cell line. 
...
```
Since different transcripts from the same gene may have different mRNA consequences (5UTR, CDS, or 3UTR) this custom script was used to only include the most common consequence per Nm site. 
```
