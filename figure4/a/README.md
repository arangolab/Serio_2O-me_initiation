# Figure 4A: Nm site distribution in human mRNAs
...
```every2OSITEdotplot.Rmd``` creates dotplots that showing the distribution of Nm sites for each mRNA consequence per study and cell line.