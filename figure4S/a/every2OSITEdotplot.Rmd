...
# read Excel file
njuHELA <- read_excel("./nju_seq/NJUSeq_Data.xlsx", sheet = "HeLa")
njuA549 <- read_excel("./nju_seq/NJUSeq_Data.xlsx", sheet = "A549")
njuHEK <- read_excel("./nju_seq/NJUSeq_Data.xlsx", sheet = "HEK293T")
...
nmmtHEPG2 <- read_excel("./nmmtseq/Nm-Mut-seq Supplementary Tables.xlsx", sheet = "S6_HepG2_mRNA_WT", skip = 2)
nmmtHELA <- read_excel("./nmmtseq/Nm-Mut-seq Supplementary Tables.xlsx", sheet = "S5_HeLa_mRNA_WT", skip = 2)
...
mlmHEPG2 <- read.table("./mlm/HepG2location0based_filtered.bed", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
mlmHEK <- read.table("./mlm/HEKlocation0based_filtered.bed", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
...
nmHELA <- read.table("./nmseq/original_bed/HeLaNm.hg38noLiftover_filtered.bed", header = FALSE, sep = "\t", stringsAsFactors = FALSE)
nmHEK <- read.table("./nmseq/original_bed/HEKNm.hg38noLiftover_filtered.bed", header = FALSE, sep = "\t", stringsAsFactors = FALSE)
