...
def collect_nm_files(input_pattern):
    ...
    for filename in glob.glob(input_pattern):
        base_filename = os.path.basename(filename)  # Get the original file name (e.g., "sample_cognates.bed")
        with open(filename, 'r') as f:
            ...
            for line in f:
                ...
                if line.endswith("Nm"):
                    ...
                    output_data[current_file].append(f"{chrom}\t{pos}\t{pos}\t{codon}\t{strand}")
