# Figure 4A: Nm site around canonical start codons in human mRNAs
...
```canonicalStartSites.Rmd``` creates dotplots showing the distribution of Nm sites around canonical start codons per cell line. 